...
class SingleBidDayAheadMarketEnvironment(gym.Env):
    
    def __init__(self, param_dict):
        self.param_dict=param_dict
        self.Q_MAX_MW = param_dict["Q_MAX_MW"]
        self.P_MAX_USD = param_dict["P_MAX_USD"]
        self.PLOT_AT_COST_OUTCOME = param_dict["PLOT_AT_COST_OUTCOME"]
        self.PLOT_MONOPOLY_OUTCOME = param_dict["PLOT_MONOPOLY_OUTCOME"]
        self.CALCULATE_REGRET = param_dict["CALCULATE_REGRET"]
        ...
        if self.DISCRETIZED:
            ...
            Q_max_min = param_dict["Q_max_min"]
            Q_max_max = param_dict["Q_max_max"]
            self.allowed_Q_maxes_MW = np.linspace(start=Q_max_min,stop=Q_max_max, num=self.num_allowed_Q_maxes)
            self.allowed_Q_maxes_MW = list(self.allowed_Q_maxes_MW)
            
            #generator MCs
            self.num_allowed_MCs = param_dict["num_allowed_MCs"]
            MC_min = param_dict["MC_min"]
            MC_max = param_dict["MC_max"]
            self.allowed_MCs_USDperMW = np.linspace(start=MC_min,stop=MC_max, num=self.num_allowed_MCs)
            ...
            demand_slope_min = param_dict["demand_slope_min"]
            demand_slope_max = param_dict["demand_slope_max"]
            self.allowed_demand_slopes_USDperMW = np.linspace(start=demand_slope_min,stop=demand_slope_max, num=self.num_allowed_demand_slopes)
            ...
            demand_intercept_min = param_dict["demand_intercept_min"]
            demand_intercept_max = param_dict["demand_intercept_max"]
            self.allowed_demand_intercepts_USD = np.linspace(start=demand_intercept_min,stop=demand_intercept_max, num=self.num_allowed_demand_intercepts)
            ...
            Q_ratio_min = param_dict["Q_ratio_min"]
            Q_ratio_max = param_dict["Q_ratio_max"]
            self.allowed_Q_ratios = np.linspace(start=Q_ratio_min, stop=Q_ratio_max, num=self.num_allowed_Q_ratios)    
            
            #ratios of MC which agents can bid in (their own MC)
            self.num_allowed_P_ratios = param_dict["num_allowed_P_ratios"]
            P_ratio_min = param_dict["P_ratio_min"]
            P_ratio_max = param_dict["P_ratio_max"]
            self.allowed_P_ratios = np.linspace(start=P_ratio_min, stop=P_ratio_max, num=self.num_allowed_P_ratios)    
